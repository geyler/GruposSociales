...
export default function Homex(props) {
  ...
  return (
    <div className="contenedor">
      ...
      <meta property="image" content={`https://gruposparaunirse.net/${rsocial}.jpg`} />
      <meta property="og:image" content={`https://gruposparaunirse.net/${rsocial}.jpg`} />
      <meta name="twitter:image" content={`https://gruposparaunirse.net/${rsocial}.jpg`} />
      <link href={`https://gruposparaunirse.net/${rsocial}.jpg`} rel="image_src"/>
      ...
      <meta property="url" content={`https://gruposparaunirse.net${props.url}`} />
      <meta property="og:url" content={`https://gruposparaunirse.net${props.url}`} />
      <link rel="canonical" href={`https://gruposparaunirse.net${props.url}`} />
