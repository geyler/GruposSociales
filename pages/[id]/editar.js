...
export default function Add(props) {
  ...
  return (
    <div className='app'>
      ...
      <meta property="url" content={`https://gruposparaunirse.net/editar`} />
      <meta property="og:url" content={`https://gruposparaunirse.net/editar`} />
      <link rel="canonical" href={`https://gruposparaunirse.net/editar`} />
     ...
     crossOrigin="anonymous"></script>
      ...
      <ArticleJsonLd
      url={`https://gruposparaunirse.net/editar`}
